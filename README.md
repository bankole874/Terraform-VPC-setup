...
Security groups were created to define inbound and outbound rul# KCVPC Project - Terraform AWS Infrastructure
...
This `README.md` explains how the project was structured, the decisions made during the setup, and the steps to deploy and manage the infrastructure.es for EC2 instances:
